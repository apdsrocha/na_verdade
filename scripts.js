...
function CardsController($scope){
    ...
    $scope.cards = [
        ...
        fonte: "Men Break More Traffic Laws, Drive More Dangerously Than Women, Concludes QPC Study, 2008 [Online | Inglês], Why Men Pay More For Auto Insurance Than Women, 2015 [Online | Inglês]"},
        ...
        fonte: "Roslyn Prinsley, Amber S. Beavis, Nicholas Clifford-Hordacre - Busting Myths About Women In STEM (2016)"
         }
    ];
